...
export const content = {
  ca: build({
    ...
    menu: ["Menús per a cada ocasió", "Migdies de cada dia, taules de cap de setmana i celebracions en grup. Tria com vols venir; nosaltres preparem la taula.", "Menú de migdia", "Cap de setmana", "Menús de grup", "Dinar bé, cada dia", "Primers, segons i postres de la casa. Consulta la selecció d’avui.", "Plats de cullera i amanides", "Peix, arrossos i carns", "Postres fetes a casa", "La taula del cap de setmana", "Una selecció més llarga per venir sense presses i compartir.", "Entrants per compartir", "Arrossos, mar i brasa", "Menús per trobar-nos", "Propostes per a celebracions, equips i taules grans.", "Opcions per compartir", "Menús acordats", "Atenció a al·lèrgies", "Veure la carta", "Menú actualitzat i reserves al 977 77 30 39"],
  ...
  es: build({
    ...
    menu: ["Menús para cada ocasión", "Mediodías de diario, mesas de fin de semana y celebraciones en grupo. Elige cómo quieres venir; nosotros preparamos la mesa.", "Menú de mediodía", "Fin de semana", "Menús de grupo", "Comer bien, cada día", "Primeros, segundos y postres de la casa. Consulta la selección de hoy.", "Platos de cuchara y ensaladas", "Pescado, arroces y carnes", "Postres hechos en casa", "La mesa del fin de semana", "Una selección más larga para venir sin prisas y compartir.", "Entrantes para compartir", "Arroces, mar y brasa", "Menús para encontrarnos", "Propuestas para celebraciones, equipos y mesas grandes.", "Opciones para compartir", "Menús acordados", "Atención a alergias", "Ver la carta", "Menú actualizado y reservas en el 977 77 30 39"],
  ...
  en: build({
    ...
    menu: ["Menus for every occasion", "Weekday lunches, relaxed weekend tables and group celebrations. Choose how you want to join us; we’ll prepare the table.", "Weekday lunch", "Weekend", "Group menus", "Eat well, every day", "House starters, mains and desserts. Ask for today’s selection.", "Soups, stews and salads", "Fish, rice and meat", "House-made desserts", "The weekend table", "A longer selection, made for unhurried sharing.", "Starters to share", "Rice, seafood and grill", "Menus for getting together", "For celebrations, teams and large tables.", "Sharing options", "Set menus", "Allergy support", "View the menu", "Current menu and bookings: +34 977 77 30 39"],
  ...
  de: build({
    ...
    menu: ["Menüs für jeden Anlass", "Mittagessen unter der Woche, entspannte Wochenenden und Feiern in der Gruppe. Wählen Sie Ihren Anlass; wir bereiten den Tisch.", "Mittagsmenü", "Wochenende", "Gruppenmenüs", "Jeden Tag gut essen", "Vorspeise, Hauptgericht und Dessert aus unserer Küche. Fragen Sie nach der heutigen Auswahl.", "Suppen, Eintöpfe und Salate", "Fisch, Reis und Fleisch", "Hausgemachte Desserts", "Der Wochenendtisch", "Eine größere Auswahl zum entspannten Teilen.", "Vorspeisen zum Teilen", "Reis, Meer und Grill", "Menüs für gemeinsame Runden", "Für Feiern, Teams und große Tische.", "Gerichte zum Teilen", "Abgestimmte Menüs", "Allergien beachten wir gern", "Speisekarte ansehen", "Aktuelles Menü und Reservierung: +34 977 77 30 39"],
  ...
  fr: build({
    ...
    menu: ["Des menus pour chaque occasion", "Déjeuners en semaine, tables du week-end et fêtes en groupe. Choisissez votre moment ; nous préparons la table.", "Menu du midi", "Week-end", "Menus de groupe", "Bien manger, chaque jour", "Entrée, plat et dessert maison. Demandez la sélection du jour.", "Soupes, plats mijotés et salades", "Poissons, riz et viandes", "Desserts maison", "La table du week-end", "Un choix plus ample, à partager sans se presser.", "Entrées à partager", "Riz, mer et grillades", "Menus pour se retrouver", "Pour les fêtes, équipes et grandes tablées.", "Plats à partager", "Menus convenus", "Attention aux allergies", "Voir la carte", "Menu du jour et réservations : +34 977 77 30 39"],
  ...
  ru: build({
    ...
    menu: ["Меню для любого повода", "Будничные обеды, неспешные выходные и праздники для групп. Выберите повод — мы подготовим стол.", "Обед по будням", "Выходные", "Групповое меню", "Хороший обед каждый день", "Закуска, основное блюдо и домашний десерт. Уточняйте выбор дня.", "Супы, рагу и салаты", "Рыба, рис и мясо", "Домашние десерты", "Стол выходного дня", "Расширенный выбор для неспешной трапезы.", "Закуски на компанию", "Рис, море и гриль", "Меню для встреч", "Для праздников, команд и больших компаний.", "Блюда на компанию", "Согласованное меню", "Учёт аллергий", "Посмотреть меню", "Актуальное меню и бронь: +34 977 77 30 39"],
