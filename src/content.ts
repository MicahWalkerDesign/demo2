...
const build = (c: Copy) => ({
  ...
  hero: { titleA: c.hero[0], titleB: c.hero[1], body: c.hero[2], menus: c.hero[3], call: c.hero[4], address: "Carrer del Batan, 3 · Reus", hours: c.hero[5], imageAlt: c.hero[6] },
  menu: {
...
export const content = {
  ca: build({
    ...
    hero: ["Cuina de sempre.", "Ànima de Reus.", "Cuina mediterrània, plats generosos i una casa feta al voltant de la taula.", "Veure la carta", "Truca’ns", "Avui · 13.00–15.30", "Fideuà de marisc servida al centre d’una taula"],
  ...
  es: build({
    ...
    hero: ["Cocina de siempre.", "Alma de Reus.", "Cocina mediterránea, platos generosos y una casa hecha alrededor de la mesa.", "Ver la carta", "Llámanos", "Hoy · 13.00–15.30", "Fideuá de marisco servida en el centro de una mesa"],
  ...
  en: build({
    ...
    hero: ["Cooking with tradition.", "The soul of Reus.", "Mediterranean cooking, generous dishes and a family house built around the table.", "View the menu", "Call us", "Today · 13:00–15:30", "Seafood fideuà served at the centre of a table"],
  ...
  de: build({
    ...
    hero: ["Küche mit Tradition.", "Die Seele von Reus.", "Mediterrane Küche, großzügige Gerichte und ein Familienhaus, in dem sich alles um den Tisch dreht.", "Speisekarte ansehen", "Anrufen", "Heute · 13:00–15:30", "Meeresfrüchte-Fideuà in der Mitte eines gedeckten Tisches"],
  ...
  fr: build({
    ...
    hero: ["Cuisine de tradition.", "L’âme de Reus.", "Cuisine méditerranéenne, assiettes généreuses et maison familiale bâtie autour de la table.", "Voir la carte", "Appelez-nous", "Aujourd’hui · 13h00–15h30", "Fideuà aux fruits de mer au centre d’une table"],
  ...
  ru: build({
    ...
    hero: ["Кухня с традициями.", "Душа Реуса.", "Средиземноморская кухня, щедрые блюда и семейный ресторан, где всё начинается за общим столом.", "Посмотреть меню", "Позвонить", "Сегодня · 13:00–15:30", "Фидеуа с морепродуктами в центре стола"],
